...
const file_auth_proto_rawDesc = "" +
	...
	"\vAuthService\x12M\n" +
	"\x1cRegisterWithEmailAndPassword\x12\x15.auth.RegisterRequest\x1a\x16.auth.RegisterResponseB\x03Z\x01.b\x06proto3"
...
var file_auth_proto_depIdxs = []int32{
	...
	1, // 1: auth.AuthService.RegisterWithEmailAndPassword:output_type -> auth.RegisterResponse
